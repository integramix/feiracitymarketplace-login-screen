...
const text_container_orange_left = document.querySelector('.orangeContainer .left .msgCentered');
const text_container_orange_right = document.querySelector('.orangeContainer .right .msgCentered');
